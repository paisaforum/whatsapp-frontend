    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-red-950 to-gray-900 flex items-center justify-center p-4">
      <div className="bg-black bg-opacity-40 backdrop-blur-lg border-2 border-red-600 rounded-2xl shadow-2xl shadow-red-900/50 p-8 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">Join Raja Games and start earning!</p>
        </div>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-600 focus:border-transparent outline-none transition"
                required
              />
              <button
                type="button"
        ...
        <p className="text-center text-xs text-gray-500 mt-6">
          By continuing, you agree to share offers with friends on WhatsApp
        </p>
      </div>
    </div>
  );
